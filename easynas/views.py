...
#http://192.168.80.128:8080/easynas/pool_status
#http://192.168.80.128:8080/easynas/get_disks

class ZPoolList(generics.ListCreateAPIView):
    model = ZPool
    serializer_class = ZPoolSerializer

class ZPoolDetail(generics.RetrieveUpdateDestroyAPIView):
    model = ZPool
    serializer_class = ZPoolSerializer
